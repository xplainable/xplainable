...
class EvaluateClassifier:
    ...
    def initialise(self):
        ...
        def on_smoother_change(_):
            self.model._calibration_map = self.model._map_calibration(self.y, self.y_prob, self.smoother.value)
            self._refresh()
    ...
    def _generate_calibration_box(self, X, y):
        ...
        def on_click(_):
            ...
            with self.scenarios:
                ...
                scenario = Scenario(self.model, self.ranges)
