...
<iframe id="iframe_D3Visualization_72066e95" src="/plot_data/D3Visualization_72066e95.html" width="100%" height="300" style={{border: "1px solid #ccc", borderRadius: "4px"}} onLoad={() => { const iframe = document.getElementById("iframe_D3Visualization_72066e95"); window.addEventListener("message", (event) => { if (event.data.type === "resize" && iframe) { iframe.style.height = event.data.height + "px"; } }); }}></iframe>
...
<iframe src='/plot_data/AltairPlot_9965d22a-069c-4f03-a532-005b7367ba28.html' width='100%' height='520'></iframe>
