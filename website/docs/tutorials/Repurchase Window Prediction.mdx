...
<iframe src='/plot_data/D3Visualization_cb025ed4.html' width='100%' height='400' style={{border: '1px solid #ccc', borderRadius: '4px'}}></iframe>
...
<iframe src='/plot_data/AltairPlot_e48c3ec3-cb4b-42b7-adcd-eb4f0b3f6a7c.html' width='100%' height='520' style={{border: '1px solid #ccc', borderRadius: '4px'}}></iframe>
