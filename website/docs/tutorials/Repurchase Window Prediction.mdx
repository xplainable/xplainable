...
<iframe id="iframe_D3Visualization_d49e33cf" src="/plot_data/D3Visualization_d49e33cf.html" width="100%" height="300" style={{border: "1px solid #ccc", borderRadius: "4px"}} onLoad={() => { const iframe = document.getElementById("iframe_D3Visualization_d49e33cf"); window.addEventListener("message", (event) => { if (event.data.type === "resize" && iframe) { iframe.style.height = event.data.height + "px"; } }); }}></iframe>
...
<iframe src='/plot_data/AltairPlot_608fb779-081c-4757-9327-a3379fc51bad.html' width='100%' height='520'></iframe>
