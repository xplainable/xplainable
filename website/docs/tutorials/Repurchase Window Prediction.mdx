...
<iframe id="iframe_D3Visualization_49a7f1be" src="/plot_data/D3Visualization_49a7f1be.html" width="100%" height="300" style={{border: "1px solid #ccc", borderRadius: "4px"}} onLoad={() => { const iframe = document.getElementById("iframe_D3Visualization_49a7f1be"); window.addEventListener("message", (event) => { if (event.data.type === "resize" && iframe) { iframe.style.height = event.data.height + "px"; } }); }}></iframe>
...
<iframe src='/plot_data/AltairPlot_c8c0ef7d-55c2-4acf-90de-8c6738969d21.html' width='100%' height='520'></iframe>
