...
# Note: The Concrete Compressive Strength dataset is typically clean with no missing values.
# This minimal pipeline ensures consistent preprocessing structure.
...
#         spec=spec,
#         name="Concrete Compressive Strength Preprocessor",
#         description="Fills missing values with median for concrete mixture data"
#     )
