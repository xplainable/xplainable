...
[31mERROR: Invalid requirement: 'xplainable=1.2.3': Expected end or semicolon (after name and no valid version specifier)
    xplainable=1.2.3
              ^
...
# Usage
data = load_heloc_data(use_kaggle=False)  # Set to False to skip Kaggle and use the local file
data.head()
...
<iframe src='/plot_data/AltairPlot_c116619d-fa91-4d97-8ce1-9443be4a8615.html' width='100%' height='520'></iframe>
