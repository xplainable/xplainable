...
# Compile and apply preprocessing
...
preprocessor_id, preprocessor_version_id = client.preprocessing.create_preprocessor(
    name="Lead Scoring Preprocessing",
    description="Predicting the Likelihood of a Lead Converting",
...
```python
preprocessor_id, preprocessor_version_id
```
...
<iframe src='/plot_data/AltairPlot_99dd7cde-ac42-4e68-ba69-fe703b3bba88.html' width='100%' height='520' style={{border: '1px solid #ccc', borderRadius: '4px'}}></iframe>
