...
|---:|:-------------|--------:|:--------------|:-----------|:------------|-----------:|:-----------------------|-----------:|------------:|:---------|:------|:-------------------|:---------------|:--------------------|:--------------------------|------------------:|:--------------|--------------:|--------------:|-------:|:------------------------------|
|  0 | 3668-QPYBK   |       1 | United States | California | Los Angeles |      90003 | 33.964131, -118.272783 |    33.9641 |    -118.273 | Male     | ...   | No                 | Month-to-month | Yes                 | Mailed check              |             53.85 | Yes           |             1 |            86 |   3239 | Competitor made better offer  |
|  1 | 9237-HQITU   |       1 | United States | California | Los Angeles |      90005 | 34.059281, -118.30742  |    34.0593 |    -118.307 | Female   | ...   | No                 | Month-to-month | Yes                 | Electronic check          |             70.7  | Yes           |             1 |            67 |   2701 | Moved                         |
|  2 | 9305-CDSKC   |       1 | United States | California | Los Angeles |      90006 | 34.048013, -118.293953 |    34.048  |    -118.294 | Female   | ...   | Yes                | Month-to-month | Yes                 | Electronic check          |             99.65 | Yes           |             1 |            86 |   5372 | Moved                         |
|  3 | 7892-POOKP   |       1 | United States | California | Los Angeles |      90010 | 34.062125, -118.315709 |    34.0621 |    -118.316 | Female   | ...   | Yes                | Month-to-month | Yes                 | Electronic check          |            104.8  | Yes           |             1 |            84 |   5003 | Moved                         |
|  4 | 0280-XJGEX   |       1 | United States | California | Los Angeles |      90015 | 34.039224, -118.266293 |    34.0392 |    -118.266 | Male     | ...   | Yes                | Month-to-month | Yes                 | Bank transfer (automatic) |            103.7  | Yes           |             1 |            89 |   5340 | Competitor had better devices |
...
<CellOutput>
{`<xplainable.preprocessing.pipeline.XPipeline at 0x2939438b0>`}
</CellOutput>
...
{`[{'feature': '__dataset__',
  'name': 'ChangeCases',
  'transformer': <xplainable.preprocessing.transformers.dataset.ChangeCases at 0x11f23ee60>},
 {'feature': 'City',
  'name': 'Condense',
  'transformer': <xplainable.preprocessing.transformers.categorical.Condense at 0x2939428f0>},
 {'feature': 'Monthly Charges',
  'name': 'SetDType',
  'transformer': <xplainable.preprocessing.transformers.mixed.SetDType at 0x293943100>},
 {'feature': '__dataset__',
  'name': 'DropCols',
  'transformer': <xplainable.preprocessing.transformers.dataset.DropCols at 0x2939418d0>}]`}
</CellOutput>
...
<CellOutput>
{`100%|██████████| 30/30 [00:02<00:00, 10.50trial/s, best loss: -0.8268936134101414]`}
</CellOutput>
...
<CellOutput>
{`<xplainable.core.ml.classification.XClassifier at 0x296183040>`}
</CellOutput>
...
<iframe src='/plot_data/AltairPlot_b1b8c8b5-cf85-4ea3-be72-7087879275e9.html' width='100%' height='520'></iframe>
...
model_id = client.create_model(
    model=model,
    model_name="Telco Customer Churn - Test",
