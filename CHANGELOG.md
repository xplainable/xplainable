...
### Fixed
- Restored `xplainable.utils.model_parsers`, `xplainable.quality`, and `xplainable.metrics` — these were incorrectly removed in v1.4.0 as dead code but are imported by `xplainable-client` and `xplainable-api`.
